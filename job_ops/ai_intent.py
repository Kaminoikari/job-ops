...
STRONG_SIGNALS: dict[str, float] = {
    ...
    "agent 開發": 5.0,
    "workflow ai": 4.5,
    # 具身智能 / 機器人基礎模型 / VLA / world model（角色本身做 AI 模型，強訊號）
    "具身智能": 5.0,
    "具身智慧": 5.0,
    "embodied ai": 5.0,
    "embodied intelligence": 5.0,
    "physical ai": 4.5,
    "vision-language-action": 5.0,
    "vla": 4.5,
    "foundation model": 4.0,
    "基礎模型": 4.0,
    "robot foundation model": 5.0,
    "world model": 4.0,
    "世界模型": 4.0,
    "imitation learning": 4.5,
    "模仿學習": 4.5,
...
MEDIUM_SIGNALS: dict[str, float] = {
    ...
    "rpa": 2.5,
    "agent": 3.0,
    # digital twin / sim-to-real / 模擬合成資料（AI 相關但用詞較泛，可能只是工具鏈）
    "digital twin": 3.0,
    "數位孿生": 3.0,
    "數位分身": 3.0,
    "sim-to-real": 3.5,
